                ...
                <form method="POST" id="form-ajax" autocomplete="off" action="<?= base_url($cont . '/act/edit') ?>" enctype="multipart/form-data">
                    <div class="form-group row">
                        <div class="col-6">
                            ...
                            <input type="hidden" class="form-control" name="id" value="<?= $gerai['id'] ?>" required />
                            <input type="text" class="form-control" name="nama_gerai" value="<?= $gerai['nama_gerai'] ?>" required placeholder="Masukkan Nama Gerai.." />
                        </div>
                        <div class="col-6">
                            <label>Alamat Gerai</label>
                            <input type="text" class="form-control" name="alamat_gerai" value="<?= $gerai['alamat_gerai'] ?>" required placeholder="Masukkan Alamat Gerai.." />
                        </div>
                        <div class="col-6">
                            <label>No Telp</label>
                            <input type="text" class="form-control" name="no_telp" value="<?= $gerai['no_telp'] ?>" required placeholder="Masukkan No Telp.." />
                        </div>
                        <!-- <div class="col-6">
                            <label>Image</label>
                    ...
                    ?>
                        <!-- <div class="form-group">
                            ...
                            <img class="img-thumbnail form-control" style="width:17%;height:auto;" src="<?= PATH_FILE . $gerai['img'] ?>">
                        </div> -->
                    <?php
                    endif;
                    ?>
