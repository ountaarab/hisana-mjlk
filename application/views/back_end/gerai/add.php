            ...
            <div class="card-body">
                ...
                <form method="POST" id="form-ajax" autocomplete="off" action="<?= base_url($cont . '/act/add') ?>" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_gerai" required placeholder="Masukkan Nama Gerai.." />
                    </div>
                    <div class="form-group">
                        <label>Alamat Gerai</label>
                        <input type="text" class="form-control" name="alamat_gerai" required placeholder="Masukkan Alamat Gerai.." />
                    </div>
                    <div class="form-group">
                        <label>No Telp</label>
                        <input type="text" class="form-control" name="no_telp" required placeholder="Masukkan No Telp.." />
                    </div>
                    <!-- <div class="form-group">
                        <label>Image</label>
