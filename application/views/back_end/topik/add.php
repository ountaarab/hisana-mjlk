    ...
    <div class="col-lg-6">
        <div class="card m-b-20">
            <div class="card-body">
                ...
                <form method="POST" id="form-ajax" autocomplete="off" action="<?= base_url('Topik/act/add') ?>" enctype="multipart/form-data">
                    <div class="form-group">
                        <label>Nama Topik</label>
                        <input type="text" class="form-control" name="nama_topik" required placeholder="Masukkan Nama Topik.." />
                    </div>
                    <div class="form-group">
                        <label>Image</label>
