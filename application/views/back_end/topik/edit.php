    ...
    <div class="col-lg-12">
        <div class="card m-b-20">
            <div class="card-body">
                ...
                <form method="POST" id="form-ajax" autocomplete="off" action="<?= base_url('Topik/act/edit') ?>" enctype="multipart/form-data">
                    <div class="form-group row">
                        <div class="col-6">
                            <label>Nama Topik</label>
                            <input type="hidden" class="form-control" name="id" value="<?= $topik['id'] ?>" required />
                            <input type="text" class="form-control" name="nama_topik" value="<?= $topik['nama_topik'] ?>" required placeholder="Masukkan Nama Topik.." />
                        </div>
                        <div class="col-6">
                            <label>Image</label>
                    ...
                    ?>
                        <div class="form-group">
                            ...
                            <img class="img-thumbnail form-control" style="width:17%;height:auto;" src="<?= PATH_FILE . $topik['img'] ?>">
                        </div>
                    <?php
                    endif;
                    ?>
